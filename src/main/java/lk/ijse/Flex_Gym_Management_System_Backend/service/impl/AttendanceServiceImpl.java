...
public class AttendanceServiceImpl implements AttendanceService {
    ...
    public AttendanceDTO markAttendance(AttendanceScanDTO attendanceScanDTO) {
        ...
        try {
            if (attendanceScanDTO == null || attendanceScanDTO.getMemberId() == null) {
                throw new RuntimeException("Attendance scan data or Member ID cannot be null!");
            }

            Optional<Member> optionalMember = memberRepository.findById(attendanceScanDTO.getMemberId());
            if (optionalMember.isEmpty()) {
                throw new RuntimeException("Member not found with ID: " + attendanceScanDTO.getMemberId());
            }
    ...
    public List<AttendanceDTO> getAllAttendanceLogs() {
        ...
        try {
            ...
            log.error("Error in getAllAttendanceLogs(): {}", e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
    ...
    public List<AttendanceDTO> getAttendanceByMemberId(Long memberId) {
        ...
        try {
            ...
            log.error("Error in getAttendanceByMemberId(): {}", e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
    ...
    public MonthlyAttendanceSummaryDTO getMonthlyAttendanceSummary(Long memberId, int year, int month) {
        ...
        try {
            ...
            log.error("Error in getMonthlyAttendanceSummary(): {}", e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
